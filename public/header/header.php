        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"
                            href="<?php echo BASE_URL; ?>/dashboard/index.php">Dashboard</a>
                    </li>
                    <li class="nav-item">
...
?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link"
                            href="<?php echo BASE_URL; ?>/login/index.php">Sign
                            in</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link"
                            href="<?php echo BASE_URL; ?>/registration/create.php">Sign
                            up</a>
                    </li>
                    <?php endif; ?>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuAvatar">
                        ...
                        <li>
                            <a class="dropdown-item"
                                href="<?php echo BASE_URL; ?>/logout/index.php">Logout</a>
                        </li>
