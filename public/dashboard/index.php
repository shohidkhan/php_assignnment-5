            ...
            <div class="col-lg-12 mt-2">
                <div class="mb-3 d-flex justify-content-end">
                    <a class="btn btn-warning"
                        href="<?php echo BASE_URL; ?>/dashboard/user/create.php">Add
                        New User</a>
                </div>
                    ...
                    <tbody class="text-white">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <?php if (isAdmin()) : ?>
                                <a href="<?php echo BASE_URL; ?>/dashboard/user/edit.php?id=<?php echo $data['id']; ?>"
                                    class="btn btn-primary btn-sm">Edit</a>
                                <?php endif; ?>
                                <?php if (isAdmin()) : ?>
                                <a href="<?php echo BASE_URL; ?>/dashboard/user/delete.php?id=<?php echo $data['id']; ?>"
